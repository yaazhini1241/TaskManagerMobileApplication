...
function Friend({data}){
   return(
      <View style={{flex:1,flexDirection:"row",justifyContent:"center",height:80,width:"100%",backgroundColor:"#fff",borderWidth:1,borderColor:"#aaa",alignItems:"center",borderRadius:10,marginBottom:10}}>
         <View style={{flex:1,alignItems:"center",flexDirection:"row",position:"absolute",left:10}}>
            ...
            <Text style={{fontSize:18,color:"#222",paddingLeft:10}}>{data.fname+" "+data.lname}</Text>
         </View>
         <View style={{flex:1,alignItems:"center",position:"absolute",right:10}}>
            <Text style={{fontSize:12,color:"#ccc"}}>Credits</Text>
            <Text style={{fontSize:22,color:"#222"}}>{data.credit}</Text>
         </View>
      </View>
   )
}
    ...
    <>
      <ScrollView style={{zIndex:100,backgroundColor:"#f0f0f0",height:"auto",width:"100%",marginBottom:60}}>
         <View style={{margin:15}}>
            <TextInput onChangeText={text=>{CallSearch(text)}} placeholder='Search' style={{marginBottom:15,borderWidth:1,borderColor:"#8C68DB",borderRadius:5,padding:10,backgroundColor:"#fff",fontSize:20}}/>
