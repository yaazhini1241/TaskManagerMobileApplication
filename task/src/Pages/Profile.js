         ...
         <View style={{height:"100%"}}>
            <ScrollView style={{backgroundColor:"#fff",borderRadius:10,borderWidth:1,borderColor:"#aaa",padding:10}}>
               ...
               <Pressable onPress={pickImage} >
                  <Text style={{marginBottom:20,backgroundColor:"#ffffff",borderWidth:1,borderColor:"#8C68DB",borderRadius:10,padding:10,fontSize:20,color:"#aaa"}} >Set Image</Text>
            ...
            <View style={{position:"absolute",bottom:5,right:20,left:20}}>
               ...
               <Pressable  >
                  <Text onPress={() => setModalVisible(false)} style={{marginBottom:20,backgroundColor:"#ff0000",borderWidth:1,borderColor:"#8C68DB",borderRadius:10,padding:10,fontSize:20,color:"#fff",textAlign:"center"}} >Cancel</Text>
               </Pressable>
            </View>
         </View>
      </Modal>

      <ScrollView style={{zIndex:100,backgroundColor:"#f0f0f0",height:"auto",width:"100%",marginBottom:60}}>
         ...
         <Text style={{fontSize:22,paddingBottom:10,color:"#666",textAlign:"center"}}>{user.email}</Text>
         ...
         <Text style={{color:"#444",fontSize:28,textAlign:"center"}}>{user.credit}</Text>
